                ...
                <div className="flex w-full flex-col items-center justify-center gap-5 md:w-1/2 md:items-start">
                    ...
                    <div className="flex flex-col items-center justify-center gap-10 md:items-start">
                        <div className="flex flex-col items-center justify-center gap-2 md:items-start">
                            ...
                            <p className="mx-auto max-w-md text-center font-poppins text-sm font-light leading-relaxed text-light-primary/85 lg:mx-0 md:text-start">
                        ...
                        <ul className="flex flex-wrap items-center justify-center gap-3 md:flex-col md:items-start md:justify-start">
                            {contact.map((item, index) => (
                                <li key={item.id ?? index} className="flex items-center gap-2">
                                    ...
                                    <span className="font-poppins text-sm font-light text-light-primary/85 max-w-xs">
                                        {item.label}
                                    </span>
                                </li>
                            ))}
